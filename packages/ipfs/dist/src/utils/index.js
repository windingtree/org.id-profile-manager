...
var startIpfsGateway = function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    return [2 /*return*/, (0, ipfs_core_1.create)()];
}); }); };
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                _b.label = 2;
            case 2: return [4 /*yield*/, asyncIterator_1.next()];
            case 3:
                if (!(asyncIterator_1_1 = _b.sent(), !asyncIterator_1_1.done)) return [3 /*break*/, 5];
            ...
            case 7:
                ...
                if (!(asyncIterator_1_1 && !asyncIterator_1_1.done && (_a = asyncIterator_1.return))) return [3 /*break*/, 9];
                return [4 /*yield*/, _a.call(asyncIterator_1)];
            case 8:
                _b.sent();
                _b.label = 9;
            ...
            case 12:
                ...
                return [2 /*return*/, decoder.decode(concatenatedData)];
        }
    });
}); };
